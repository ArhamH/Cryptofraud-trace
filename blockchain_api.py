...
caching, and instant O(1) price resolution to eliminate latency.
"""
...
# Persistent Connection Pooling Session
...
def annotate_usd_values(transfers, chain_key):
    for t in transfers:
        ...
        if sym in STABLES:
            ...
            t["usd"], t["priced"] = t["amount"] * 1.0, True  # conservative fallback
    return transfers
